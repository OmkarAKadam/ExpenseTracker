...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Poppins',sans-serif;}
        ...
        @keyframes fade{
            from{opacity:.3;transform:translateY(15px);}
            to{opacity:1;}
        }
...
<div class="container">
    ...
    <table class="expense-table">
        ...
        <tbody>
        <%
            boolean hasData = (expenses != null && !expenses.isEmpty());
        ...
        %>
                    <tr>
                        ...
                        <td class="action-col">
                            <a href="EditExpenseServlet?id=<%= exp[0] %>" class="btn-edit">Edit</a>
                            <a href="DeleteExpenseServlet?id=<%= exp[0] %>"
                               class="btn-delete"
